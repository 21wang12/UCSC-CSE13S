 ...
 *	@pass : unit-test
 *  @pass : valgrind
 *	@date : 04/26/2021 02:10:38 AM 
 */

//ref@asgn4.pdf : section 3. Representing Graphs whose subsections define for the interface for the graph ADT.
...
Graph *graph_create(uint32_t vertices, bool undirected){
	...
	//g->visited = (bool *)malloc(vertices*sizeof(bool));
	for(uint32_t i = 0;i < vertices; i++){
		g->visited[i] = false;
	}
	//g->matrix = (uint32_t **)malloc(vertices*sizeof(uint32_t *))
	for(uint32_t i = 0;i < vertices; i++){
